...
menu = pygame.image.load(resource_path("images/menu.png"))
sw_village = pygame.image.load(resource_path("images/sw_vil.png"))
sw_farm = pygame.image.load(resource_path("images/sw_far.png"))
sw_mar = pygame.image.load(resource_path("images/sw_mar.png"))
forest1 = pygame.image.load(resource_path("images/forest_1.png"))
forest2 = pygame.image.load(resource_path("images/forest_2.png"))
forest3 = pygame.image.load(resource_path("images/forest_3.png"))
road_mud = pygame.image.load(resource_path("images/road_mud.png"))
dog_white = pygame.image.load(resource_path("images/dog.png"))
boss_p = pygame.image.load(resource_path("images/boss.png"))
boss_killed = pygame.image.load(resource_path("images/boss_killed.png"))
killed_Ending = pygame.image.load(resource_path("images/killed_ending.png"))
...
cat_run_frames = [
    pygame.image.load(resource_path("images/cat_r1.png")).convert_alpha(),
    pygame.image.load(resource_path("images/cat_r2.png")).convert_alpha(),
    pygame.image.load(resource_path("images/cat_r3.png")).convert_alpha(),
    pygame.image.load(resource_path("images/cat_r4.png")).convert_alpha(),
    pygame.image.load(resource_path("images/cat_r5.png")).convert_alpha()
]

bullet_C = pygame.image.load(resource_path("images/attack_c.png")).convert_alpha()
